...
function init(){
	...
	background.addColorStop(0,'#D1EBFE');	
	background.addColorStop(0.02,'#5BB318');
	background.addColorStop(0.15,'#2B7A0B');
	background.addColorStop(0.25,'#503C3C');
	background.addColorStop(0.3,'blue');
	background.addColorStop(0.45,'#39A7FF');
	background.addColorStop(0.5,'#00A9FF');
	background.addColorStop(0.55,'#39A7FF');
	background.addColorStop(0.7,'blue');
	background.addColorStop(0.73,'#654321');
	background.addColorStop(0.75,'#2B7A0B');
	background.addColorStop(0.98,'#5BB318');
	background.addColorStop(1,'#D1EBFE');
